...
Requires:       python3-neutron-dynamic-routing >= 12.0.0
Requires:       python3-neutron-lib >= 2.0.0
Requires:       python3-openstackclient >= 4.0.0
...
Requires:       openstack-neutron-l2gw >= 15.0.0
Requires:       openstack-neutron-dynamic-routing >= 15.0.0.0
Requires:       openstack-neutron >= 15.0.0.0
